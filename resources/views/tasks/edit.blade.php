        ...
        <div class="bg-white dark:bg-gray-800 shadow sm:rounded p-6">
            <form method="post" action="{{ route('tasks.update', $task) }}" class="space-y-4">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <button class="inline-flex items-center justify-center rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-500">Update</button>
                </div>
            </form>
        </div>
    </div>
